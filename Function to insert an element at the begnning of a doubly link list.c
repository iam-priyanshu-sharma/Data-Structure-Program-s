/*Function to insert an element at the begnning of a doubly link list*/
#include<stdio.h>
#include<conio.h>
#include<stdlib.h>
...
void insbeg(node **h,node **t)
    {
        int ele;
        node *ptr;
        printf("\nEnter elements to be inserted at begnning:");
        scanf("%d", &ele);
        ptr = (node *)malloc(sizeof(node));
        ptr->info = ele;
        ptr->prev = NULL;
